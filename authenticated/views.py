...
from.serializers import RegisterSerializer, ResetPasswordEmailSerializer, SetNewPasswordSerializer,\
...
class VerifyEmail(views.APIView):
    ...
    token_param_config = openapi.Parametr(
        ...
        try:
            ...
            if redirect_url and len(redirect_url)>3:
                return CustomRedirect(
                    redirect_url + '?token_valid=True&message=Credentials Validuidb64=' +uidb64 + '?token='+ token)
            else:
